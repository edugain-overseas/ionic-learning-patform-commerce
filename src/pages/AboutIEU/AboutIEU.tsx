import { IonBackButton, IonHeader, IonImg, IonPage } from "@ionic/react";
    ...
    <IonPage>
      ...
      <DoubleScrollLayout topLabel="About University" posterSrc={poster}>
        ...
        <div className={styles.textBlock}>
          ...
          <p>
            We are the <b>right choice for you</b>! What is the best university
            to study medicine in Malta? Sure, International European University,
            Malta Campus is the best option for students seeking to pursue an
            MBBS course in Malta.
          </p>
        </div>
